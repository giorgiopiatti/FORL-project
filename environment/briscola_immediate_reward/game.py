...
from environment.briscola_immediate_reward.utils import CARD_RANK_WITHIN_SUIT, Roles, DEBUG_ENV
from environment.briscola_immediate_reward.player import BriscolaPlayer
from environment.briscola_immediate_reward.round import BriscolaRound
from environment.briscola_immediate_reward.judger import BriscolaJudger
...
class BriscolaGame:
    ...
    def step(self, action):
        ...
        Args:
            action (str): specific action of briscola_immediate_reward. Eg: '33344'
