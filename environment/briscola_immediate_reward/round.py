from environment.briscola_immediate_reward.utils import CARD_RANK_WITHIN_SUIT_INDEX
from environment.briscola_immediate_reward.utils import CARD_POINTS
